 ...
 */
@interface PrinterData_DPL : NSObject<NSCoding> {
    /**
 ...
 * @return Value of the parameter.
 */
-(double) parse_SpeedInInchesPerSec: (NSString *) name;
 ...
 * @param value Value to set
 */
-(int) set_SpeedInInchesPerSec: (NSString *)name withValue: (double) value;
 ...
 * @return Value of the parameter.
 */
-(double) parse_SpeedInMillimeterPerSec: (NSString *) name;
 ...
 * @param value Value to set
 */
-(int) set_SpeedInMillimeterPerSec: (NSString *)name withValue: (double) value;
